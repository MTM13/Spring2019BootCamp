...
public class Methods {
	...
	public static void main(String[] args) {
          /*
           * methods
           * reusable code, maintainable code, 
           * write once and use it whenever needed
           * 3 question to ask while creating a method:
           ...
           * if yes put data type and name : Parameter separated by comma
